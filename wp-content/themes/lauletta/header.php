...
<link href="<?php bloginfo('template_directory'); ?>/css/lauletta-style.css" rel="stylesheet" type="text/css" />
<!--if [lte IE 8]><link href="<?php bloginfo('template_directory'); ?>/css/ie.css" rel="stylesheet" type="text/css" /><![endif]-->
...
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/jquery-ui-1.7.3.min.js"></script>
...
<div id="mainWrapper">
    ...
    <div id="wrapper">
        ...
        <div id="header">
            ...
            <!-- END MAIN MENU -->
      <div id="call-header-link">
        <a href="tel:8562321600">Call Now! 856.232.1600</a>
      </div><!--/#call-header-link-->
			...
			<div id="topSocial">
				<ul>
					...
					<li><a href="<?php echo get_option('boldy_linkedin_link'); ?>" class="linkedin" title="Join us on LinkedIn!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_linkedin.png" alt="LinkedIn" target="_blank" /></a></li>
					<?php }?>
					<?php if(get_option('boldy_twitter_user')!=""){ ?>
					<li><a href="http://www.twitter.com/<?php echo get_option('boldy_twitter_user'); ?>" class="twitter" title="Follow Us on Twitter!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_twitter.png" alt="Follow Us on Twitter!" target="_blank" /></a></li>
					<?php }?>
					<?php if(get_option('boldy_facebook_link')!=""){ ?>
					<li><a href="<?php echo get_option('boldy_facebook_link'); ?>" class="twitter" title="Join Us on Facebook!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_facebook.png" alt="Join Us on Facebook!" target="_blank" /></a></li>
					<?php }?>
